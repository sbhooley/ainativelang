...
tests/                  — 1053 `*.py` files under `tests/` (~307k lines total); 218 `test_*.py` modules; pytest —collect-only: 1395/1434 (see STATUS.yaml). Definitions: **`STATUS.yaml`** → `real_and_working.tests`.
