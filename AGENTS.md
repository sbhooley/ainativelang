...
tests/                  — 256 `*.py` files under `tests/` (~31k lines total); 226 `test_*.py` modules; pytest —collect-only: 1477/1516 (see STATUS.yaml). Definitions: **`STATUS.yaml`** → `real_and_working.tests`.
