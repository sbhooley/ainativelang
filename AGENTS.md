...
tests/                  — 1057 `*.py` files under `tests/` (~308k lines total); 222 `test_*.py` modules; pytest —collect-only: 1445/1484 (see STATUS.yaml). Definitions: **`STATUS.yaml`** → `real_and_working.tests`.
