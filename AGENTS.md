...
tests/                  — 254 `*.py` files under `tests/` (~31k lines total); 224 `test_*.py` modules; pytest —collect-only: 1460/1499 (see STATUS.yaml). Definitions: **`STATUS.yaml`** → `real_and_working.tests`.
