...
### Positioning note (v1.2.8–v1.7.0): OpenClaw operations, host integrations, token economics, graph-authored intelligence, self-monitoring, Solana, and ArmaraOS
...
### Positioning note (v1.3.0–v1.7.0): Hermes, OpenClaw CLI, Solana, ArmaraOS, and core/runtime polish
...
### 10.5 Intelligence runner, hydration, and cap tuning (v1.2.8–v1.7.0)
...
### OpenClaw operations and intelligence (v1.2.8–v1.7.0)
...
### Hermes, Solana, ArmaraOS (v1.3.0–v1.7.0)
...
The AINL whitepaper (v1.0–v1.7.0) theorized **graph-as-memory** architecture as a foundational departure from traditional agent memory systems. The core thesis:
