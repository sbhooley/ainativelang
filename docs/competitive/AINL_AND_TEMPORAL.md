...
You do not have to pick one: from **v1.2.5**, validate can emit Temporal-shaped Python modules from the same IR that powers the core runtime (**current release: v1.3.1**).
