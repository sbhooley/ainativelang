...
> **Moved:** the ZeroClaw install guide is now a section of the consolidated MCP host integrations doc.
>
> **Canonical home:** [`integrations/MCP_HOSTS.md#zeroclaw`](integrations/MCP_HOSTS.md#zeroclaw)
