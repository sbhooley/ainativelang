...
**v1.8.0 / latest Solana onboarding — fastest start is [docs/solana_quickstart.md](../solana_quickstart.md) + [examples/prediction_market_demo.ainl](../../examples/prediction_market_demo.ainl).**
