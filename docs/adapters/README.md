...
- [`AINL_GRAPH_MEMORY.md`](AINL_GRAPH_MEMORY.md) — **`ainl_graph_memory`** (JSON graph store, ArmaraOS bridge), IR ops **`MemoryRecall`** / **`MemorySearch`**, optional graph viz server; demos **`demo/procedural_roundtrip_demo.py`**, **`demo/ainl_graph_memory_demo.py`**
