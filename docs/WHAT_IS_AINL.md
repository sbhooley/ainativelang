...
| OpenClaw gold standard + host briefing (v1.2.8) | `docs/operations/OPENCLAW_AINL_GOLD_STANDARD.md`, `docs/operations/OPENCLAW_HOST_AINL_1_2_8.md` |
...
| Adapter catalog (vector_memory, tool_registry, memory) | `docs/reference/ADAPTER_REGISTRY.md` |
...
Long-form architecture: [`WHITEPAPERDRAFT.md`](../WHITEPAPERDRAFT.md) (repository root) — includes **v1.2.8** positioning on OpenClaw intelligence, token caps, embedding pilot, graph-runtime pitfalls, and the weekly cap auto-tuner.
