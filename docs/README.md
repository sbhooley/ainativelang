...
**Current `ainl` release:** **v1.3.3** — [`CHANGELOG.md`](CHANGELOG.md), [`RELEASE_NOTES.md`](RELEASE_NOTES.md) (PyPI / **`RUNTIME_VERSION`** / citation metadata).
...
- **Long-form architecture / economics:** **[`WHITEPAPERDRAFT.md`](../WHITEPAPERDRAFT.md)** (repo root) — through **v1.3.3** (native Solana + OpenClaw intelligence ops, token caps, Hermes Agent, `ainl install openclaw`, `ainl status`).
