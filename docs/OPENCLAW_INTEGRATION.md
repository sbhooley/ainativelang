...
- **AINL v1.8.0 — host briefing (what the repo includes vs what OpenClaw must do; PyPI mirrors this line after upload):** [`operations/OPENCLAW_HOST_AINL_1_2_8.md`](operations/OPENCLAW_HOST_AINL_1_2_8.md) — **`openclaw_host_ainl_1_2_8`** — **`docs/RELEASING.md`**
