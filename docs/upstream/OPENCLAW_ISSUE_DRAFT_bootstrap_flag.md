...
- AINL **v1.2.8+** includes a wrapper `token_aware_startup_context.ainl` that generates the compact context file on a schedule (e.g., every 15 minutes); **current PyPI: v1.5.2**.
