...
|------|---------|----------|
| **Release line** | **PyPI / runtime `ainl-lang` 1.2.6** (`pyproject.toml`, **`RUNTIME_VERSION`**, **`CITATION.cff`**) — see **`docs/RELEASE_NOTES.md`** / **`docs/CHANGELOG.md`** | `docs/RELEASING.md` |
