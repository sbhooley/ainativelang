...
## Recently shipped (through **v1.7.0** — keep docs/tests aligned)
...
|------|---------|----------|
| **Release line** | **PyPI / runtime `ainativelang` 1.7.0** (`pyproject.toml`, **`RUNTIME_VERSION`**, **`CITATION.cff`**) — see **`docs/RELEASE_NOTES.md`** / **`docs/CHANGELOG.md`** | `docs/RELEASING.md` |
