...
|------|---------|----------|
| **Release line** | **`ainativelang` 1.8.0** target line (`pyproject.toml`, **`RUNTIME_VERSION`**, **`CITATION.cff`**) — **PyPI** after publish; see **`docs/RELEASE_NOTES.md`** / **`docs/CHANGELOG.md`** | `docs/RELEASING.md` |
