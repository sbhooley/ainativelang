...
**AINL v1.8.0 host briefing (what the repo ships vs what OpenClaw must do; PyPI mirrors this line after upload):** [`OPENCLAW_HOST_AINL_1_2_8.md`](OPENCLAW_HOST_AINL_1_2_8.md) — copy-paste ready for operators; **`tooling/bot_bootstrap.json`** → **`openclaw_host_ainl_1_2_8`** — **`docs/RELEASING.md`**.
...
This configuration is **fully compliant** with AINL v1.8.0 gold standard semantics, with only a **profile emission** deviation that is **safe and scoped**.
...
- **Machine-readable:** `tooling/bot_bootstrap.json` → **`openclaw_ainl_gold_standard`** (checklist) · **`openclaw_host_ainl_1_2_8`** (v1.2.8–v1.8.0 host briefing: repo vs host)
- **Hub:** [`HOST_PACK_OPENCLAW.md`](HOST_PACK_OPENCLAW.md) · [`docs/README.md`](../README.md) § operations · [`DOCS_INDEX.md`](../DOCS_INDEX.md)
- **OpenClaw requests 2–6 mapping:** [`OPENCLAW_REQUESTS_2_6_MAPPING.md`](OPENCLAW_REQUESTS_2_6_MAPPING.md) (what’s shipped through v1.8.0 vs proposed extensions; see doc header)
