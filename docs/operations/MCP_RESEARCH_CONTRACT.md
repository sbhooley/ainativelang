...
## Stability note (v1.4.4 release line)

The following fields are considered stable in the v1.2.7+ research pack surface (current **`RUNTIME_VERSION`** **1.4.4**):
...
## `ainl_run` execution contract (v1.4.3+; current package **1.4.4**)
