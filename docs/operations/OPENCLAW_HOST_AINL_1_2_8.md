# OpenClaw host briefing — AINL **v1.2.8 / v1.3.0 / v1.3.1 / v1.3.2** (install / update)
...
## What the AINL **v1.2.8 / v1.3.0 / v1.3.1 / v1.3.2** repo includes (you consume; you don’t reimplement)
...
The AINL **v1.3.2** tree delivers **measurement**, **rolling-budget → cache hydration**, **profiles**, **caps staging docs**, and **clear host responsibilities** (built on **v1.3.0** OpenClaw/Hermes polish and **v1.2.8** intelligence ops).
