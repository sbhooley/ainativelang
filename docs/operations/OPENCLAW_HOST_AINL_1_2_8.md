# OpenClaw host briefing — AINL **v1.2.8+ through v1.8.0** (install / update)
...
## What the AINL **v1.2.8+ through v1.8.0** repo includes (you consume; you don’t reimplement)
...
The AINL **v1.8.0** tree (plus prior **v1.3.x** baselines) delivers **measurement**, **rolling-budget → cache hydration**, **profiles**, **caps staging docs**, and **clear host responsibilities** (built on **v1.3.0** OpenClaw/Hermes polish and **v1.2.8** intelligence ops).
