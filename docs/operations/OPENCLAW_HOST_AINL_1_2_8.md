...
The AINL **v1.3.3** tree delivers **measurement**, **rolling-budget → cache hydration**, **profiles**, **caps staging docs**, and **clear host responsibilities** (built on **v1.3.0** OpenClaw/Hermes polish and **v1.2.8** intelligence ops).
