...
- [`OPENCLAW_HOST_AINL_1_2_8.md`](OPENCLAW_HOST_AINL_1_2_8.md) — **AINL v1.2.8–v1.4.0 host briefing** (bridge probe, rolling hydrate, profiles, explicit OpenClaw responsibilities); **`openclaw_host_ainl_1_2_8`**
