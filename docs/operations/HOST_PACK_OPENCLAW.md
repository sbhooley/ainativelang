...
**AINL v1.3.1 — host responsibilities (what ships vs what you must wire):** [`OPENCLAW_HOST_AINL_1_2_8.md`](OPENCLAW_HOST_AINL_1_2_8.md) — **`openclaw_host_ainl_1_2_8`** (bridge probe, rolling hydrate, profiles, explicit OpenClaw obligations).
