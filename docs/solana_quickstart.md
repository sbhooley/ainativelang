# Solana strict graphs — quickstart (AINL v1.8.0)
...
- **"Where is the Solana adapter and what verbs does the current release support for prediction markets?"** → `adapters/solana.py` module docstring (DISCOVERABILITY section; aligns with **`RUNTIME_VERSION`**).
