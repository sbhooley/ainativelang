# Solana strict graphs — quickstart (AINL v1.3.1)
...
- **"Where is the Solana adapter and what verbs does v1.3.1 support for prediction markets?"** → `adapters/solana.py` module docstring (DISCOVERABILITY section).
