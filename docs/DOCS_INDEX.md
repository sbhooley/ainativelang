...
- **Consultant reports index**: `agent_reports/CONSULTANT_REPORTS.md` (see also `agent_reports/AI_CONSULTANT_REPORT_APOLLO.md`)
...
- **OpenClaw host briefing — AINL v1.2.8–v1.8.0 (what ships vs host obligations; v1.8.0 target line; PyPI after publish):** `docs/operations/OPENCLAW_HOST_AINL_1_2_8.md` — **`openclaw_host_ainl_1_2_8`** — `docs/RELEASING.md`
...
- **Integrations hub (A2A, HTTP machine payments, agentic commerce map):** `docs/integrations/README.md` — **x402** / **MPP** on **`http`** (`HTTP_MACHINE_PAYMENTS.md`), practitioner readiness + backlog (`AGENTIC_PROTOCOLS_PRACTITIONER_READINESS.md`), **AGTP** options (`AGTP.md`), **A2A** (`A2A_ADAPTER.md`).
