...
- **ArmaraOS bridge runner + JSON graph memory:** `armaraos/bridge/runner.py` · `docs/adapters/AINL_GRAPH_MEMORY.md` · `docs/ARMARAOS_INTEGRATION.md` · Python bootstrap `adapters/armaraos_integration.py` · tests `tests/test_armaraos_monitor_registry.py`
