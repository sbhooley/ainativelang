...
They are narrative continuity artifacts, not the same template as the `AI_CONSULTANT_REPORT_*.md` files in this directory.
...
Save reports as `AI_CONSULTANT_REPORT_<CONSULTANT_ID>.md` in `agent_reports/`.
