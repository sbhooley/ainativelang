...
- `README.md`
- **`docs/CHANGELOG.md`** / **`docs/RELEASE_NOTES.md`** — **current release v1.5.1** (see also **`pyproject.toml`**, **`runtime/engine.py`** **`RUNTIME_VERSION`**). Solana / prediction-market contributions: **`docs/solana_quickstart.md`** (including the community-team section).
- `docs/DOCS_INDEX.md`
- `docs/AINL_SPEC.md`
- `SEMANTICS.md`
