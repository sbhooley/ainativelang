...
**PyPI:** `ainativelang` **v1.3.2** (optional extras: `[mcp]`, `[solana]`).
...
- **Host briefing — AINL v1.3.2 (what ships vs what OpenClaw must wire; doc key `openclaw_host_ainl_1_2_8`):** [docs/operations/OPENCLAW_HOST_AINL_1_2_8.md](https://github.com/sbhooley/ainativelang/blob/main/docs/operations/OPENCLAW_HOST_AINL_1_2_8.md) — `openclaw_host_ainl_1_2_8`
- OpenClaw: [openclaw.ai](https://openclaw.ai/)
- Package: **`ainativelang`** on PyPI — **current release v1.3.2**
