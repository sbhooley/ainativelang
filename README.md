...
- Whitepaper draft (architecture, benchmarks, OpenClaw ops + token economics through **v1.4.0**, async runtime, reactive DB/realtime adapters; native Solana — **`docs/solana_quickstart.md`**): **`WHITEPAPERDRAFT.md`**
