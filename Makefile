.PHONY: conformance benchmark benchmark-ci
...
# Benchmarks (requires: pip install .[dev,benchmark])
benchmark: ## Run all benchmarks locally (updates default JSON + markdown)
...
benchmark-ci: ## Run benchmarks like CI (JSON only, tooling/*_ci.json)
