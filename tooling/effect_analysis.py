...
ADAPTER_EFFECT: Dict[str, Tuple[str, str]] = {
    ...
    "pggraph.TEST_ENABLED": (EFFECT_TIER_IO_READ, EFFECT_KIND_DB_READ),
    "pggraph.STATUS": (EFFECT_TIER_IO_READ, EFFECT_KIND_DB_READ),
    "pggraph.SEARCH": (EFFECT_TIER_IO_READ, EFFECT_KIND_DB_READ),
    "pggraph.TRAVERSE": (EFFECT_TIER_IO_READ, EFFECT_KIND_DB_READ),
    "pggraph.SHORTEST_PATH": (EFFECT_TIER_IO_READ, EFFECT_KIND_DB_READ),
    "pggraph.FIND_RELATED": (EFFECT_TIER_IO_READ, EFFECT_KIND_DB_READ),
    "pggraph.BUILD": (EFFECT_TIER_IO_WRITE, EFFECT_KIND_DB_WRITE),
    "pggraph.AUTO_DISCOVER": (EFFECT_TIER_IO_WRITE, EFFECT_KIND_DB_WRITE),
    "pggraph.RESET": (EFFECT_TIER_IO_WRITE, EFFECT_KIND_DB_WRITE),
    ...
    "ainl_graph_memory.MEMORY_PATCH": (EFFECT_TIER_IO_WRITE, EFFECT_KIND_MEMORY_WRITE),
    ...
    # browser adapter (real Chrome/Chromium via ArmaraOS CDP — see adapters/browser.py)
    "browser.NAVIGATE": (EFFECT_TIER_IO_READ, EFFECT_KIND_HTTP),
    "browser.READ_PAGE": (EFFECT_TIER_IO_READ, EFFECT_KIND_HTTP),
    "browser.SCREENSHOT": (EFFECT_TIER_IO_READ, EFFECT_KIND_HTTP),
    "browser.RUN_JS": (EFFECT_TIER_IO_READ, EFFECT_KIND_HTTP),
    "browser.SCROLL": (EFFECT_TIER_IO_WRITE, EFFECT_KIND_HTTP),
    "browser.WAIT": (EFFECT_TIER_IO_READ, EFFECT_KIND_HTTP),
    "browser.BACK": (EFFECT_TIER_IO_WRITE, EFFECT_KIND_HTTP),
    "browser.CLICK": (EFFECT_TIER_IO_WRITE, EFFECT_KIND_HTTP),
    "browser.TYPE": (EFFECT_TIER_IO_WRITE, EFFECT_KIND_HTTP),
    "browser.SESSION_START": (EFFECT_TIER_IO_WRITE, EFFECT_KIND_HTTP),
    "browser.SESSION_STATUS": (EFFECT_TIER_IO_READ, EFFECT_KIND_HTTP),
    "browser.CLOSE": (EFFECT_TIER_IO_WRITE, EFFECT_KIND_HTTP),
    # tiktok adapter
